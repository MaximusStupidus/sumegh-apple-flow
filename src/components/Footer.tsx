          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-apple text-background/80 text-sm">011-25920165-166</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-background/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="font-apple text-background/80 text-sm">sumeghconsultancy@gmail.com</span>
              </div>
            </div>
          </div>
